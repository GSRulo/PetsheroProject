...
<body>
	<% 
		...
		ArrayList<Reports> denunciasAbertas = (ArrayList<Reports>) session.getAttribute("denunciasAbertas");
		@SuppressWarnings ("unchecked")
		ArrayList<Reports> denunciasEncerradas = (ArrayList<Reports>) session.getAttribute("denunciasEncerradas");
	%>
	<!-- IMPORTS PAGES -->
	...
	<section class="banner-reports mask-bg d-flex align-items-center justify-content-center">
		...
		<p>Quando o assunto é denúncia de maus-tratos ou crueldade contra animais, o Brasil possui legislação pertinente
			e autoridades competentes que são responsáveis pela manutenção da lei e punição de crimes</p>

		<p> Caso você presencie maus-tratos a animais de quaisquer espécies, sejam domésticos, domesticados, silvestres
			ou exóticos – como abandono, envenenamento, presos constantemente em correntes ou cordas muito
			curtas, manutenção em lugar anti-higiênico, mutilação, presos em espaço incompatível ao porte do animal ou
			em local sem iluminação e ventilação, utilização em shows que possam lhes causar lesão, pânico ou estresse,
			agressão
		...
		<p>§ 2º. “A pena é aumentada de um sexto a um terço, se ocorre morte do animal.”
			prevaricação, previsto no Art. 329 do Código Penal Brasileiro (retardar ou deixar de praticar indevidamente,
		...
		<p>Não se cale frente aos crimes contra os animais e o meio ambiente, e exija das autoridades responsáveis às
			providências previstas por lei.</p>

		<p>Em São Paulo, você pode realizar a denuncia através da Divisão de investigações sobre Infrações de Maus
			Tratos a Animais e demais Infrações
			contra o Meio Ambiente.</p>

		<p><strong>Endereço: Av. São João, 1247 - 7º andar - Centro, das 9 às 19h. Tel.: (11) 3224-8208, (11) 3224-8480
		...
		<p>As denúncias também podem ser feitas no site da Delegacia Eletrônica de Proteção Animal (DEPA):
			...
			No Rio de Janeiro, você pode realizar a denuncia através da DEMA - Delegacia de Proteção ao Meio Ambiente.
		</p>

		<p><strong>Endereço: Rua S. Luiz, 265 - São Cristóvão. Tel.: (21) 3399-3290, (21) 3399-3298 e (21) 2589-3133.
				Fax.: (21) 3860-9030 e (21) 3860-3293.</strong></p>
				
				<a href="#ancora" class="btn btn-danger ancora">Não se cale, denúncie. <i class="fas fa-exclamation-circle"></i></a>
                                                    ...
                                                    <div class="card card-body">
                                                        <form class="form-edit" action="denuncia" method="post"
                                                            ...
                                                            <div class="form-group">
                                                            	...
                                                            	<input class="form-control" name="titulo_reports" value="${item.titulo}" required />
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                            	...
                                                            	<textarea rows="5" cols="5" name="descricao" class="form-control" required>${item.descricao}</textarea>
                                                            </div>
                                                            ...
                                                            <input type="hidden" name="editar" value="${item.idReports}" required />
                                                            <div class="form-group">
                                                            	<button type="submit" class="btn btn-first btn-block">Salvar</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                            	<form class="mt-2" action="denuncia" method="post">
                                            		<input type="hidden" name="delete" value="${item.idReports}" required />
                                            		<button class="btn btn-danger btn-block text-white font-weight-bold">
                                            			Deletar
                                            		</button>
                                            	</form>
                                            </c:if>
		...
		$(document).ready(function(){
			...
			$(".form-edit").on("submit", function(){
            	if($(this).valid()){
            		var btn = $(this).find("button[type=submit]");
    				btn.attr("disabled",true);
    				btn.html('Atualizando <span class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>');
            	}
            });
